...
describe('Test to edit Tag adding Slug with more than the max of characters (191)', () => {
    ...
    it('5 Edit tag', () => {
        ...
        cy.wait(1000);
        cy.xpath('//input[@name="slug"]').type(faker.random.numeric(200));
        cy.wait(1000);
    ...
    it('6 Responds with Retry button', () => {
    ...
    it('7 Clear Tag Slug and try to save Tag', () => {
        cy.xpath('//input[@name="slug"]').clear();
        cy.wait(1000);
        cy.xpath('//input[@name="slug"]').type(tagName, { force: true });
        cy.wait(1000);
        cy.xpath('//span[text()="Retry"]').click();
        cy.wait(2000);
    })
