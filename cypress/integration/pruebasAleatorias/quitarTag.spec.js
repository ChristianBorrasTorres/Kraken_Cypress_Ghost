...
describe('Test to remove Tag from Post', () => {
    ...
    it('7 Test Enter Title', () => {
        pageObject.selectPostTitle().type(faker.random.word());
        pageObject.selectPostBody().type(faker.lorem.paragraph());
        cy.wait(2000);
        cy.screenshot();
    });        
    ...
    it('9 Test go to settings and add tag', () => {
        ...
        cy.wait(3000);
        pageObject.selectTagOptions().contains(tagName).click();
        cy.screenshot();
    })
    ...
    it('11 Test go to settings and remove tag', () => {
        pageObject.selectPostSettings();
        cy.wait(3000);
        pageObject.selectAddedTag().contains(tagName);
