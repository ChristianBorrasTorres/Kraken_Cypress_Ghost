...
describe('Test to create member without correct e-mail (invalid domain name)', () => {
    ...
    it('4 Test type Member E-Mail', () => {
        pageObject.selectTextfieldMemberEmail().type(faker.internet.email() + faker.random.word());
        cy.wait(2000);
