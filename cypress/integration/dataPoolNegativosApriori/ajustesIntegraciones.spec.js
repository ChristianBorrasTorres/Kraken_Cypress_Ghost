import MOCK_DATA from './schemas_mockaroo/settingsIntegrationsNegative.json'
...
describe(`Testing Settings Integration DataPoolApriori Negative Scenarios ${index}`, () => {
